...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="參考資料" tabindex="-1"><a class="header-anchor" href="#參考資料" aria-hidden="true">#</a> 參考資料</h2>`,21),u={href:"https://blog.miniasp.com/post/2019/02/25/Creating-Self-signed-Certificate-using-OpenSSL",target:"_blank",rel:"noopener noreferrer"};function v(h,m){const a=s("ExternalLinkIcon");return i(),r("div",null,[p,e("p",null,[e("a",u,[d("如何使用 OpenSSL 建立開發測試用途的自簽憑證 (Self-Signed Certificate)"),l(a)])])])}const g=n(o,[["render",v],["__file","index.html.vue"]]);export{g as default};
