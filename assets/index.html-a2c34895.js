import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as s,f as e}from"./app-775521e3.js";const t={},i=e(`<h3 id="修改設定檔" tabindex="-1"><a class="header-anchor" href="#修改設定檔" aria-hidden="true">#</a> 修改設定檔</h3><pre><code>/etc/php/8.1/fpm/php.ini
</code></pre><h3 id="調整擴充模組的-extension-註解-可參考" tabindex="-1"><a class="header-anchor" href="#調整擴充模組的-extension-註解-可參考" aria-hidden="true">#</a> 調整擴充模組的 extension 註解 可參考</h3><div class="language-ini line-numbers-mode" data-ext="ini"><pre class="language-ini"><code><span class="token key attr-name">extension</span><span class="token punctuation">=</span><span class="token value attr-value">bz2</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,22),l=[i];function c(p,o){return a(),s("div",null,l)}const u=n(t,[["render",c],["__file","index.html.vue"]]);export{u as default};
