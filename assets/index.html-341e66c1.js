...
[Service]
# 指向專案目錄
WorkingDirectory=/home/pamis/TCA_DEV_API
# 指向專案執行檔案
ExecStart=/usr/bin/dotnet /home/pamis/TCA_DEV_API/TCA_DEV_API.dll
# 指向專案執行檔案 並指定 位址與埠號
# ExecStart=/usr/bin/dotnet /home/pamis/TCA_DEV_API/TCA_DEV_API.dll --url http://0.0.0.0:5000
Restart=always
