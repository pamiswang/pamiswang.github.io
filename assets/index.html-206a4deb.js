...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果在 <code>10.2.1</code> 這個版本，會發現轉場動畫特效無法正常顯示，<br> 然而在 <code>9.13.0</code> 這個版本，轉場動畫特效卻可以正常運作。<br> 雖然 github 上有些人提出的解決方式是透過降板來處理，<br> 但為了一探究竟我們將會把兩個版本的源碼做簡單的分析。</p><h2 id="源碼查看" tabindex="-1"><a class="header-anchor" href="#源碼查看" aria-hidden="true">#</a> 源碼查看</h2><p>透過 VSCode 查看 <code>useDark()</code> 的定義<br> 點開檔案 node_modules@vueuse\\core\\index.d.ts</p><h3 id="index-d-ts" tabindex="-1"><a class="header-anchor" href="#index-d-ts" aria-hidden="true">#</a> index.d.ts</h3><h4 id="usedark" tabindex="-1"><a class="header-anchor" href="#usedark" aria-hidden="true">#</a> useDark</h4><p>位於第 965 行</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">/**
